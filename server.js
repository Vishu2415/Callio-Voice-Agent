...
function resolveBranding(host) {
  ...
  if (reseller) {
    ...
    return {
      ...
      appName: appName,
      logoUrl: b.logoUrl || 'callio_logo.svg',
      logoHeight: b.logoHeight ? Number(b.logoHeight) : 36,
      faviconUrl: b.faviconUrl || 'favicon.ico',
      authHeroUrl: b.authHeroUrl || b.auth_hero_url || 'calling_mockup_3d.png',
  ...
  return {
    ...
    logoUrl: def.logoUrl || 'callio_logo.svg',
    logoHeight: def.logoHeight ? Number(def.logoHeight) : 36,
    faviconUrl: def.faviconUrl || 'favicon.ico',
    authHeroUrl: def.authHeroUrl || def.auth_hero_url || 'calling_mockup_3d.png',
